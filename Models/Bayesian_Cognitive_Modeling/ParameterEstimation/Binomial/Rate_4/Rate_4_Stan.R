...
path <- "Models/Bayesian_Cognitive_Modeling/ParameterEstimation/Binomial/Rate_4/"
# to be passed on to Stan
data <- read_rdump(paste0(path,"Rate_4.data.R"))
...
samples <- stan(file=paste0(path,"Rate_4.stan"),   
                data=data, 
