...
library(rstan)
path <- "Models/Bayesian_Cognitive_Modeling/ParameterEstimation/Binomial/Survey/"
# to be passed on to Stan
data <- read_rdump(paste0(path,"Survey.data.R"))
...
samples2 <- stan(file=paste0(path,"Survey.stan"),   
                data=data, 
