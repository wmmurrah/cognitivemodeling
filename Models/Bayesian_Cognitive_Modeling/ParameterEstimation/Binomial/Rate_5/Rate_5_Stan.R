...
library(rstan)
path <- "Models/Bayesian_Cognitive_Modeling/ParameterEstimation/Binomial/Rate_5/"
# to be passed on to Stan
data <- read_rdump(paste0(path,"Rate_5.data.R"))
...
samples <- stan(file=paste0(path,"Rate_5.stan"),   
                data=data, 
