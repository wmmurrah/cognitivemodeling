#**************************************************************************
# Title: Regexample_CMCB.R
# Author: William Murrah
# Description: copied from:
#   https://github.com/psy-farrell/computational-modelling/blob/master/codeFromBook/Chapter3/regexample.R
...
getregpred <- function(parms,data) {
  ...
  par(ask=TRUE)
  plot   (data[ ,2], type="n", las=1, ylim=c(-2,2), xlim=c(-2,2), xlab="X", 
          ylab="Y")
  par(ask=FALSE)
