...
sr.stan <- stan("stan/Howell_height/height_simpleRegression.stan", 
                data = data,
...
rsamod <- stan_glm(height ~ weight, df, family = gaussian)
print(rsamod, digits = 3)
summary(rsamod, digits = 3)
